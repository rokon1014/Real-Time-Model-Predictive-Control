...
if("FALSE" STREQUAL "TRUE")
  set(openni2_launch_SOURCE_PREFIX /tmp/buildd/ros-hydro-openni2-launch-0.1.4-0precise-20150111-1814)
  set(openni2_launch_DEVEL_PREFIX /tmp/buildd/ros-hydro-openni2-launch-0.1.4-0precise-20150111-1814/obj-x86_64-linux-gnu/devel)
  ...
  set(openni2_launch_INSTALL_PREFIX /opt/ros/hydro)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'openni2_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/hydro/${idir}'.  Ask the maintainer 'Michael Ferguson <developers@unboundedrobotics.com>' to fix it.")
    endif()
