...
bool robot(unit::from_robot::Request &req, unit::from_robot::Response &res)
{
...

	{
...

		{
			...
			float cost=squared((pos[0])*11.0f)+ squared(angle*8.0f) ;
...
int main(int argc, char **argv)
{
	...
	odeBodySetPosition(ball.body,-0.08,0.00,h_floor_table+h_base+h_sphere+h_support+stage_dim[2]);
