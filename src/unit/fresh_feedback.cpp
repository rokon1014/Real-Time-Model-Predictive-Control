...
////////////////FEEDBACKS//////////////////////////////////////////////////////////////////////////////////////////
	...
	float angle_f=odeJointGetHingeAngle(LinkBall.joint);
	...
	//odeJointSetHingeParam(LinkBall.joint,dParamVel,DesiredVelocity);
	//stepOde(1);
	
	angle_f=odeJointGetHingeAngle(LinkBall.joint);
	...
	if (debug) printf("vel of the body %f and real ball %f \n", vel[1], vel_robot);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...

	{
...

		{
			...
			//COST FUNCTION
			float cost=squared((0.02-pos[0])*13.0f)+ squared(angle*8.0f) ;
