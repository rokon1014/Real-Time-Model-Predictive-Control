...
info.request.angle = m-1.31650;  //TODO: check this probably wrong
...
//{
 //msg.position = {va1,va2,ve1,va3,va4,desired_vel*(0.198),va6};
  msg.position = {va1,va2,ve1,va3,desired_velX, -desired_velY,va6};  // best working so far  0.19    for double 0.7 
