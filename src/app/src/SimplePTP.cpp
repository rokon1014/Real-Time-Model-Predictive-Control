...
/*
//good one//
double a1 = (86.97*3.1416)/180 ; // -0.350812
double a2 = (-76.63*M_PI)/180 ;  // 1.75433
double a3 = (-3.85*3.1416)/180 ; //1.5708
double a4 = (88.39*3.1416)/180 ;  //1.4947
double a5 = (78.39*3.1416)/180 ;   //-0.0195477
double a6 = (-23.37*3.1416)/180 ;  // 2.04064
double e1 = (-89.46*3.1416)/180 ;  // -0.0160571

////
*/
//with temporary camera//

double a1 = (79.32*3.1416)/180 ; // -0.350812
double a2 = (-83.57*M_PI)/180 ;  // 1.75433
double a3 = (-3.43*3.1416)/180 ; //1.5708
double a4 = (89.46*3.1416)/180 ;  //1.4947
double a5 = (84.04*3.1416)/180 ;   //-0.0195477
double a6 = (-14.23*3.1416)/180 ;  // 2.04064
double e1 = (-89.46*3.1416)/180 ;  // -0.0160571
