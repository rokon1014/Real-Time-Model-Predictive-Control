...
if("TRUE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/intelligentrobotics/rokon_clone/October/src/main)
  set(main_DEVEL_PREFIX /home/intelligentrobotics/rokon_clone/October/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/intelligentrobotics/rokon_clone/October/install)
...
if(NOT "/home/intelligentrobotics/rokon_clone/October/src/main/include" STREQUAL "")
  set(main_INCLUDE_DIRS "")
  set(_include_dirs "/home/intelligentrobotics/rokon_clone/October/src/main/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Your Name <you@example.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/intelligentrobotics/rokon_clone/October/src/main/${idir}'.  Ask the maintainer 'Your Name <you@example.com>' to fix it.")
    endif()
