...
if("TRUE" STREQUAL "TRUE")
  set(moveit_resources_SOURCE_PREFIX /home/intelligentrobotics/rokon/src/moveit/src/moveit_resources)
  set(moveit_resources_DEVEL_PREFIX /home/intelligentrobotics/rokon/devel)
  ...
  set(moveit_resources_INSTALL_PREFIX /home/intelligentrobotics/rokon/install)
...
if(NOT "/home/intelligentrobotics/rokon/src/moveit/src/moveit_resources/include" STREQUAL "")
  set(moveit_resources_INCLUDE_DIRS "")
  set(_include_dirs "/home/intelligentrobotics/rokon/src/moveit/src/moveit_resources/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'moveit_resources' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/intelligentrobotics/rokon/src/moveit/src/moveit_resources/${idir}'.  Ask the maintainer 'Ioan Sucan <isucan@willowgarage.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(moveit_resources_LIBRARIES ${moveit_resources_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${moveit_resources_dep}_LIBRARIES})
  _list_append_deduplicate(moveit_resources_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(moveit_resources_LIBRARIES ${moveit_resources_LIBRARIES})
